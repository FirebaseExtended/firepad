...
ot.AnnotationList = (function (global) {
  var Span = global.ot ? global.ot.Span : require('./span');
...
if (typeof module === 'object') {
  module.exports = ot.AnnotationList;
}
...
ot.RichTextCodeMirror = (function (global) {
  var AnnotationList = global.ot ? global.ot.AnnotationList : require('./annotation-list');
  var Span = global.ot ? global.ot.Span : require('./span');
  ...
  RichTextCodeMirror.prototype.initAnnotationList_ = function() {
    ...
    var end = this.codeMirror.indexFromPos({line: lastLine, ch: this.codeMirror.getLine(lastLine).length});
    if (end !== 0) {
...
ot.RichTextCodeMirrorAdapter = (function () {
  'use strict';
...
ot.FirebaseAdapter = (function (global) {
  var TextOperation = global.ot ? global.ot.TextOperation : require('./text-operation');
  var utils = global.ot ? global.ot.utils : require('./utils');
...
ot.RichTextToolbar = (function(global) {
  var utils = global.ot ? global.ot.utils : require('./utils');
...
// Export for CommonJS
if (typeof module === 'object') {
  module.exports = ot.RichTextToolbar;
}

var Firepad = (function(global) {
  var RichTextCodeMirrorAdapter = global.ot ? global.ot.RichTextCodeMirrorAdapter : require('./rich-text-codemirror-adapter');
  var RichTextCodeMirror = global.ot ? global.ot.RichTextCodeMirror : require('./rich-text-codemirror');
  var RichTextToolbar = global.ot ? global.ot.RichTextToolbar : require('./rich-text-toolbar');
  var FirebaseAdapter = global.ot ? global.ot.FirebaseAdapter : require('./firebase-adapter');
  var EditorClient = global.ot ? global.ot.EditorClient : require('./editor-client');
  var utils = global.ot ? global.ot.utils : require('./utils');

...
firepad.Firepad = (function(global) {
  ...
  Firepad.prototype.insertText = function(textPieces, origin, shouldEmpty) {
    ...
    if (this.ace_) {
      ...
      var end = (origin != null) ? origin : this.codeMirror_.indexFromPos(this.codeMirror_.getCursor()), atNewLine = false, shouldEmpty = shouldEmpty || false, self = this;
  ...
  Firepad.prototype.getHtmlFromRange = function(start, end) {
    var doc = (start != null && end != null) ? this.getOperationForSpan(start, end) : this. this.firebaseAdapter_.getDocument();

...
firepad.Firepad = (function(global) {
  ...
  Firepad.prototype.getHtml = function() {
    ...
    function open(listType) {
      return (listType === LIST_TYPE.ORDERED) ? '<ol>' : (listType === LIST_TYPE.UNORDERED) ? '<ul>' : '';
    }
    ...
    function start_li(listType) {
        if (listType == LIST_TYPE.TODO || listType == LIST_TYPE.TODOCHECKED)
          html += "<input type='checkbox'" + (listType == LIST_TYPE.TODOCHECKED ? " checked" : "") + " />";
        else
          html += "<li>";
    }
    
    function end_li(listType) {
        if (listType == LIST_TYPE.TODO || listType == LIST_TYPE.TODOCHECKED)
          ;
        else
          html += "</li>";
    ...
    function start_align(align) {
        if (align != "left")
            html += "<div style='text-align:" + align + ";'>";
    }

    function end_align(align) {
        if (align != "left")
            html += "</div>";
    }

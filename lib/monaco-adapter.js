firepad.MonacoAdapter = (function() {
  ...
  MonacoAdapter.prototype.detach = function() {
    ...
    this.monaco.onDidBlurEditor(this.onBlur).dispose();
    this.monaco.onDidFocusEditor(this.onFocus).dispose();
    this.monaco.onDidChangeCursorPosition(this.onCursorActivity).dispose();
  };

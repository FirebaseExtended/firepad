...
firepad.FirebaseAdapter = (function (global) {
  ...
  FirebaseAdapter.prototype.saveCheckpoint = function(frequency, callback) {
    frequency = frequency || CHECKPOINT_FREQUENCY;
    if (this.revision_ % frequency == 0) {
      this.saveCheckpoint_(function() {
        callback(true);
      });
    } else {
      callback(false);
  ...
  FirebaseAdapter.prototype.saveCheckpoint_ = function(callback) {
